 ...
 *   SECTION 2 — Run as PG (schema owner)
 *
...
-- (CREATE ROLE + GRANT privileges on PG schema)
-- ============================================================
...
-- Admin: full access
GRANT SELECT, INSERT, UPDATE, DELETE ON pg.brands TO sc_admin;
GRANT SELECT, INSERT, UPDATE, DELETE ON pg.products TO sc_admin;
GRANT SELECT, INSERT, UPDATE, DELETE ON pg.fulfillment_centers TO sc_admin;
GRANT SELECT, INSERT, UPDATE, DELETE ON pg.inventory TO sc_admin;
GRANT SELECT, INSERT, UPDATE, DELETE ON pg.customers TO sc_admin;
GRANT SELECT, INSERT, UPDATE, DELETE ON pg.orders TO sc_admin;
GRANT SELECT, INSERT, UPDATE, DELETE ON pg.order_items TO sc_admin;
GRANT SELECT, INSERT, UPDATE, DELETE ON pg.influencers TO sc_admin;
GRANT SELECT, INSERT, UPDATE, DELETE ON pg.social_posts TO sc_admin;
GRANT SELECT, INSERT, UPDATE, DELETE ON pg.agent_actions TO sc_admin;
GRANT SELECT, INSERT, UPDATE, DELETE ON pg.app_users TO sc_admin;

-- Analyst: read all, write forecasts
GRANT SELECT ON pg.brands TO sc_analyst;
GRANT SELECT ON pg.products TO sc_analyst;
GRANT SELECT ON pg.orders TO sc_analyst;
GRANT SELECT ON pg.order_items TO sc_analyst;
GRANT SELECT ON pg.social_posts TO sc_analyst;
GRANT SELECT ON pg.influencers TO sc_analyst;
GRANT SELECT ON pg.inventory TO sc_analyst;
GRANT SELECT ON pg.fulfillment_centers TO sc_analyst;
GRANT SELECT, INSERT, UPDATE ON pg.demand_forecasts TO sc_analyst;
GRANT SELECT ON pg.agent_actions TO sc_analyst;

-- Fulfillment Manager: manage inventory and shipments
GRANT SELECT ON pg.products TO sc_fulfillment_mgr;
GRANT SELECT ON pg.orders TO sc_fulfillment_mgr;
GRANT SELECT ON pg.order_items TO sc_fulfillment_mgr;
GRANT SELECT, UPDATE ON pg.inventory TO sc_fulfillment_mgr;
GRANT SELECT, UPDATE ON pg.fulfillment_centers TO sc_fulfillment_mgr;
GRANT SELECT, INSERT, UPDATE ON pg.shipments TO sc_fulfillment_mgr;

-- Merchandiser: manage products, view social
GRANT SELECT, INSERT, UPDATE ON pg.brands TO sc_merchandiser;
GRANT SELECT, INSERT, UPDATE ON pg.products TO sc_merchandiser;
GRANT SELECT ON pg.social_posts TO sc_merchandiser;
GRANT SELECT ON pg.influencers TO sc_merchandiser;
GRANT SELECT ON pg.demand_forecasts TO sc_merchandiser;

-- Viewer: read-only on key tables
GRANT SELECT ON pg.brands TO sc_viewer;
GRANT SELECT ON pg.products TO sc_viewer;
GRANT SELECT ON pg.social_posts TO sc_viewer;
GRANT SELECT ON pg.influencers TO sc_viewer;
...
-- VPD policy function for store fulfillment site regional access
