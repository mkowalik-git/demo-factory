# Scene 6 Rights, Capacity and Live Event Coverage
...
3. Focus on visible hubs such as **Atlanta Theatrical Launch Desk**, **Seattle Live Event Operations Hub**, **Boston Premium Originals Hub**, **Charlotte Matchday Operations Hub**, and **Chicago Midwest Ad Ops Hub**.
...
3. Use examples such as **Championship Highlights Rights** or **Cloudbreak City Watch Party Kit** to discuss how demand can exceed available rights or activation capacity.
