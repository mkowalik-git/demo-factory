# Scene 1 Welcome and Midnight Harbor Story Orientation
...
2. Review the headline **Media and Entertainment intelligence on one governed Oracle data platform**.
3. Read the opening copy about Seer Media and the Midnight Harbor premiere weekend.
4. Explain that the demo connects studios, streamers, sports media teams, content publishers, ad-sales teams, and operations teams on one governed platform.
...
1. Scroll to **Key Media and Entertainment Use Cases Featured**.
