...
![Agent Console navigation, runtime profile, agent workspace, and recent actions highlighted](images/agent-workspace.png)
...
![Agent question and Send control highlighted](images/agent-question.png)
...
![Routed specialist, supporting rows, and recent action highlighted](images/agent-audit.png)
